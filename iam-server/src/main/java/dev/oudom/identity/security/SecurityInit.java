...
public class SecurityInit {
    ...
    void initOAuth2() {
        ...
        ClientSettings portalClientSettings = ClientSettings.builder()
                .requireProofKey(false)
                .requireAuthorizationConsent(false)
                .build();

        var miniStadoorPortal = RegisteredClient.withId("mini-stadoor-portal")
                .clientId("mini-stadoor-portal")
                .clientSecret(passwordEncoder.encode("mini-stadoor-portal-secret"))
                .scopes(scopes -> {
                ...
                .postLogoutRedirectUris(uris -> {
                    uris.add("http://localhost:3000/login");
                ...
                .clientSettings(portalClientSettings)
                .tokenSettings(tokenSettings)
                .build();

        var miniStadoorPostman = RegisteredClient.withId("mini-stadoor-postman")
                .clientId("mini-stadoor-postman")
                .clientSecret(passwordEncoder.encode("mini-stadoor-postman-secret"))
                .scopes(scopes -> {
                    scopes.add(OidcScopes.OPENID);
                    scopes.add(OidcScopes.PROFILE);
                    scopes.add(OidcScopes.EMAIL);
                ...
                .redirectUris(uris -> {
                    uris.add("https://oauth.pstmn.io/v1/browser-callback");
                })
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantTypes(grantTypes -> {
                    grantTypes.add(AuthorizationGrantType.AUTHORIZATION_CODE);
        ...
        RegisteredClient registeredClient4 = jpaRegisteredClientRepository.findByClientId("mini-stadoor-portal");
        RegisteredClient registeredClient5 = jpaRegisteredClientRepository.findByClientId("mini-stadoor-postman");
        ...
        log.info("Registered client4: {}", registeredClient4);
        log.info("Registered client5: {}", registeredClient5);
        ...
        if (registeredClient4 == null) {
            jpaRegisteredClientRepository.save(miniStadoorPortal);
        }

        if (registeredClient5 == null) {
            jpaRegisteredClientRepository.save(miniStadoorPostman);
        }
